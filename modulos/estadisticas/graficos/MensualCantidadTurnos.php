<?php    
	...
	for($i=1;$i<=$total_dias;$i++){
		...
		$query="SELECT numeroVenta AS nro FROM ventas WHERE fechaVenta >= '$anio-$mes-$dia 00:00:00' AND fechaVenta <= '$anio-$mes-$dia 23:59:59'";
	...
	if($mes != $mes2){
		$promedio = round((($total_gral/$total_dias*100)))/100;
	}
	else{
